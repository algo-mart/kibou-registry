...
public class AttendanceServiceImpl implements AttendanceService {
    ...
    public AttendanceResponse recordAttendance(AttendanceRequest attendance) {
        ...
        var participant = participantsRepo.findById(attendance.getParticipantId()).orElseThrow(
                ()-> new ParticipantNotFoundException(attendance.getParticipantId())
        );
        ...
        var event = eventsRepo.findById(attendance.getEventId()).orElseThrow(() ->
                new EventsNotFoundException(attendance.getEventId()));
    ...
    public Long getMonthlyActiveUsers(YearMonth month) {
        ...
        return attendanceRepo.countDistinctParticipantsBetween(start, end);
    }
    }
